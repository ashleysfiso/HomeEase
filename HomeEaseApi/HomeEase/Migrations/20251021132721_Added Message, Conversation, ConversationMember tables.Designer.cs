...
namespace HomeEase.Migrations
{
    ...
    [Migration("20251021132721_Added Message, Conversation, ConversationMember tables")]
    partial class AddedMessageConversationConversationMembertables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeEase.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeEase.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeEase.Models.ConversationMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeEase.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeEase.Models.NotificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeEase.Models.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeEase.Models.ConversationMember", b =>
                {
                    b.HasOne("HomeEase.Models.Conversation", "Conversation")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("HomeEase.Models.Message", b =>
                {
                    ...
                    b.HasOne("HomeEase.Models.AppUser", "Sender")
            ...
            modelBuilder.Entity("HomeEase.Models.Review", b =>
                {
                    b.HasOne("HomeEase.Models.Booking", "Booking")
                        .WithOne("Review")
                        .HasForeignKey("HomeEase.Models.Review", "BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
